...
> (独立部署实例:端口、数据、页面均与 JT808 平台完全隔离)
...
| 轨迹地图页面 | `http://186.244.238.6:18309/` |
| 数据查询 API | `http://186.244.238.6:18309/api/devices` |
...
2. 打开 `http://186.244.238.6:18309/`,左侧设备列表出现设备号,标签显示 **MQTT**;
3. 点选设备:实时跟踪画轨迹,右下角遥测面板显示车速/方向/陀螺仪;
4. 接口核验:`GET http://186.244.238.6:18309/api/devices/{devId}/latest`,
